...
def lambda_handler(event, context):
    ...
    if request_type == 'Create':
        ...
        primary_nsip_public_ip = event['ResourceProperties']['PriPubNSIP']
        ...
        secondary_nsip_public_ip = event['ResourceProperties']['SecPubNSIP']
